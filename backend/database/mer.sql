    ...
    ('12345678', 'DOC1', '08:00:00', '2026-01-10'),
    ('23456789', 'DOC2', '09:30:00', '2026-01-11'),
    ('34567890', 'DOC3', '11:15:00', '2026-01-12'),
    ('45678901', 'DOC4', '14:00:00', '2026-01-13'),
    ('56789012', 'DOC5', '16:45:00', '2026-01-14');

    INSERT INTO documentos (id_documentos, id_categoria, titulo_docs, descripcion_docs) VALUES
    ('DOC1', 'CAT1', 'Protocolo Cardiologia', 'Guia de urgencias cardiacas'),
    ('DOC2', 'CAT2', 'Ficha Pediatrica', 'Registro de vacunacion'),
    ('DOC3', 'CAT3', 'Informe Traumatologia', 'Inventario de protesis'),
    ('DOC4', 'CAT4', 'Guia Neurologia', 'Procedimiento de EEG'),
    ('DOC5', 'CAT5', 'Control Triaje', 'Manual de atencion rapida');
    ...
    ('PREG1', 'ENC1', '¿Como evalua la atencion en el especialista?', 'opcion multiple'),
    ('PREG2', 'ENC1', 'Describa la comodidad de la sala de espera', 'texto'),
    ('PREG3', 'ENC2', '¿El medico explico bien el tratamiento?', 'opcion multiple'),
    ('PREG4', 'ENC3', 'Escriba sugerencias para mejorar el servicio', 'texto'),
    ('PREG5', 'ENC5', '¿Consiguio turno con rapidez?', 'opcion multiple');

    INSERT INTO respuesta (id_respuesta, id_pregunta, id_encuesta, informacion, tipo) VALUES
    ('RESP1', 'PREG1', 'ENC1', 'Excelente', 'opcion multiple'),
    ('RESP2', 'PREG2', 'ENC1', 'Hacen falta mas asientos en el pasillo', 'texto'),
    ('RESP3', 'PREG3', 'ENC2', 'Bueno', 'opcion multiple'),
    ('RESP4', 'PREG4', 'ENC3', 'Agilizar la entrega de resultados', 'texto'),
    ('RESP5', 'PREG5', 'ENC5', 'Regular', 'opcion multiple');
    ...
    ('TRAS1', '12345678', 'SCH1234', 'DEST1', '66666666', '2026-08-01', '08:00:00', '08:45:00', 'Hospital de Clinicas', 'denegado'),
    ('TRAS2', '22222222', 'SAB5678', 'DEST2', '77777777', '2026-08-02', '09:30:00', '10:15:00', 'Hospital de Clinicas', 'denegado'),
    ('TRAS3', '33333333', 'SBX9012', 'DEST3', '88888888', '2026-08-03', '11:00:00', '11:30:00', 'Hospital de Clinicas', 'aprobado'),
    ('TRAS4', '44444444', 'SCA3456', 'DEST4', '99999999', '2026-08-04', '14:15:00', '15:00:00', 'Hospital de Clinicas', 'aprobado'),
    ('TRAS5', '55555555', 'SDY7890', 'DEST5', '10101010', '2026-08-05', '16:00:00', '17:20:00', 'Hospital de Clinicas', 'en proceso');
